...
Route::get('/pembeli', [PembeliController::class, 'tahu']);
Route::get('/suplier', [SuplierController::class, 'tahu']);
Route::get('/pesanan', [PesananController::class, 'tahu']);